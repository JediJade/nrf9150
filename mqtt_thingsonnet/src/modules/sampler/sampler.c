...
#define FORMAT_STRING "{\"applicationID\":1,\"battery\":39,\"devEUI\":\"24e124785d199269\",\"deviceName\":\"TestEM320-TH\",\"humidity\":50.5,\"temperature\":22.2}"
...
static void sample(void)
{
	...
	len = snprintk(payload.string, sizeof(payload.string), FORMAT_STRING);
